...
S.UI = (function () {
  ...
  function checkInputWidth() {
    if (document.querySelector('.ui-input').value.length > 18) {
      ui = document.querySelector('.ui').classList.add('ui--wide');
    } else {
      ui = document.querySelector('.ui').classList.remove('ui--wide');
    }

    if (firstAction && document.querySelector('.ui-input').value.length > 0) {
      ui = document.querySelector('.ui').classList.add('ui--enter');
    } else {
      ui = document.querySelector('.ui').classList.remove('ui--enter');
    }
  }

  function bindEvents() {
    document.body.addEventListener('keydown', function (e) {
      document.querySelector('.ui-input').focus();

      if (e.keyCode === 13) {
        firstAction = false;
        reset();
        performAction(document.querySelector('.ui-input').value);
      }
    });
    ...
    document.querySelector('.ui-input').addEventListener('input', checkInputWidth);
    document.querySelector('.ui-input').addEventListener('change', checkInputWidth);
    document.querySelector('.ui-input').addEventListener('focus', checkInputWidth);
